...
void main() async {
  ...
  // Khởi tạo cấu hình API trước khi khởi tạo các service sử dụng ApiConfig.baseUrl
  await ApiConfig.init(
      lanIp: const String.fromEnvironment('LAN_IP', defaultValue: ''));
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<ReportService>(
        ...
        builder: (context, themeProvider, child) {
          return MaterialApp(
            ...
            theme: ThemeData(
              ...
              inputDecorationTheme: InputDecorationTheme(
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                  borderSide:
                      const BorderSide(color: Color(0xFF00CCFF), width: 2),
                ),
            ...
            routes: {
              ...
              RegisterOrganizerScreen.routeName: (context) =>
              ...
              OrganizerProfileScreen.routeName: (context) =>
                  const OrganizerProfileScreen(),
              ReportHistoryScreen.routeName: (context) => 
